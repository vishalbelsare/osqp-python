...
class update_matrices_tests(unittest.TestCase):
    ...
    def test_solve(self):
        ...
        nptest.assert_array_almost_equal(res.x,
            np.array([0.00380355, -0.05288448, 0.81394426, -0.10583796, -0.05073545]))
        nptest.assert_array_almost_equal(res.y,
            np.array([0, 0., 0., 0., 0., -1.04731486, 0., 0.]))
        nptest.assert_array_almost_equal(res.info.obj_val, -0.50827192)
    ...
    def test_update_P(self):
        ...
        # Assert close
        nptest.assert_array_almost_equal(res.x,
            np.array([0.04720881, -0.06776865, 0.86134936, -0.11074795, -0.09258846]))
        nptest.assert_array_almost_equal(res.y,
            np.array([0, 0., 0., 0., 0., -1.0260579, 0., 0.]))
        nptest.assert_array_almost_equal(res.info.obj_val, -0.55292652)
    ...
    def test_update_A(self):
        ...
        # Assert close
        nptest.assert_array_almost_equal(res.x,
            np.array([0.06691278, 0.08556721, 0.07404456, -0.18316578, -0.25791392]))
        nptest.assert_array_almost_equal(res.y,
            np.array([-0.48881119, 0., 0., -0.07316356, 0., -0.29852164, 0., -1.14361885]))
        nptest.assert_array_almost_equal(res.info.obj_val, -0.10000495)
    ...
    def test_update_P_A_indP_indA(self):
        ...
        # Assert close
        nptest.assert_array_almost_equal(res.x,
            np.array([0.07135987, 0.0912541, 0.07896563, -0.19533916, -0.27505513]))
        nptest.assert_array_almost_equal(res.y,
            np.array([-0.50970015, 0., 0., -0.07650362, 0., -0.29287553, 0., -1.19697277]))
        nptest.assert_array_almost_equal(res.info.obj_val, -0.10665138)
